 ...
 * Class DeleteTest
 *
 * @covers \rwt\SwiftPDO\Queries\Delete
 */
class DeleteTest extends TestCase
{
    ...
    {
        $query = $this->swift->deleteFrom('user')
            ->where('id', 1);
    ...
    {
        $query = $this->swift->deleteFrom('user', 1);
    ...
    {
        $query = $this->swift->delete('user', 1)->from('user');
